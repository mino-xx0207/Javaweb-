...
<div id="tn-content">
        ...
        <div class="tn-box tn-widget tn-widget-content tn-corner-all it-home-box">
            <div class="tn-box-content tn-widget-content tn-corner-all">
                ...
                <div class="it-home-present">
                    <div class="it-present-btn"><a class=" tn-button tn-button-home-apply" href="JobServlet?type=show&jobid=<%=job.getJobId()%>">
                        <span class="tn-button-text">管理</span> </a></div>
    ...
    <div class="page01">
        ...
        <div class="page03"><a href="managerIndex.jsp?pageNo=1">首页 </a></div>
        <% if (pagination.isHasPreviousPage()) { %>
        <div class="page03">
            <a href='managerIndex.jsp?pageNo=<%=pagination.getPageNo()-1%>'>上一页 </a></div>
        <% } %>
        <% if (pagination.isHasNextPage()) { %>
        <div class="page03"><a href="managerIndex.jsp?pageNo=<%=pagination.getPageNo()+1%>">下一页 </a></div>
        <% } %>
        <div class="page03"><a href="managerIndex.jsp?pageNo=<%=pagination.getTotalPages()%>">尾页</a></div>
