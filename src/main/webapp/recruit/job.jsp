  ...
  <div class="bottomban">
    <div class="bottombanbox">
      <a href="CompanyServlet?type=select&id=${requestScope.company.companyId }">
        <img src="recruit/images/${requestScope.company.companyPic }"></a> </div>
  </div>
</div>
<div class="tn-grid">
      ...
      <div class="job">
        ...
        <div class="btn_bot">
          <a class="tn-button-secondary" href="CompanyServlet?type=select&id=${requestScope.company.companyId }">
            <span style="color:#3399ff"  class="tn-button-text">查看公司信息</span>
          </a>
          <a class="tn-button-secondary" href="JobApplyServlet?type=apply&jobid=${requestScope.job.jobId }">
