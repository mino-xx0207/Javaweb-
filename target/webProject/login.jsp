    ...
    if (cookies != null) {
        for (Cookie cookie : cookies) {
            if ("COOKIE_APPLICANTEMAIL".equals(cookie.getName())) {
                ...
                applicantEmail = com.xfb.utils.CookieEncryptTool.decodeBase64(cookie.getValue());
            }
            if ("COOKIE_APPLICANTPWD".equals(cookie.getName())) {
                // 解密获取存储在Cookie中的求职者登录密码
                applicantPwd = com.xfb.utils.CookieEncryptTool.decodeBase64(cookie.getValue());
            }
        }
    }
%>
    ...
    <div class="login_content">
        ...
        <form action="ApplicantLoginServlet" method="post"
            ...
            <div class="login_l">
                ...
                <input type="radio" name="sex"checked="checked"value="1"><span style="color: #3399ff">普通用户</span>
                <input type="radio" name="sex"value="2"><span style="color: #3399ff">管理员</span>
            </div>
                ...
                <div class="tn-form-row-button">
                    <div class="span1">
                        <input name="submit" type="submit" class="tn-button-text"
                            ...
                            for="RememberMe" style="color: gray"> 记住密码</label></span>
                    </div>
                </div>
                <div class="clear"></div>
                <!-- 从拦截器中获取被拦截前的请求地址 -->
