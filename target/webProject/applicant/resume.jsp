...
<%@ page
		import="com.xfb.dao.ResumeDAO,com.xfb.bean.ResumeBasicinfo,com.xfb.bean.Applicant"%>
<%
...
<jsp:useBean id="basicinfo" class="com.xfb.bean.ResumeBasicinfo" scope="request"></jsp:useBean>
